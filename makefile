...
TARGET_NAME      := EyecatcherAnimation
BOARD_ID         := TEENSY40
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=148 -DARDUINO=10807
...
BIN         := C:\Users\stefa\Desktop\DesignLab\Eyecatcher\EyecatcherAnimation\.vsteensy\build
USR_BIN     := $(BIN)/src
CORE_BIN    := $(BIN)/core
LIB_BIN     := $(BIN)/lib
CORE_LIB    := $(BIN)/core.a
